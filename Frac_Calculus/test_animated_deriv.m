% Performs derivation of x(t) = t, using alpha from 0 to 1, and animate
...
for alpha = 0:0.05:1
    ...
    if k == 1;
        imwrite(imind,cm,'fderiv.gif','gif', 'Loopcount',inf);
    else
        imwrite(imind,cm,'fderiv.gif','gif','WriteMode','append');
    end
    k = k + 1;
end